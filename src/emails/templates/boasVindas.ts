export const emailBoasVindas = (dados: {
    nome: string;
    matricula: string;
}) => {
    return `
                ...
                <div style="padding: 30px 20px;">
                    ...
                    <div style="background-color: #f9f9f9; padding: 15px; margin: 20px 0; border-left: 4px solid #c41e3a;">
                        <p style="margin: 0; color: #333;">
                            <strong>Sua matrícula:</strong> ${dados.matricula}
                        </p>
                    </div>
                    ...
                    <ul style="color: #666; line-height: 1.8;">
                        <li>Comprar ingressos para os jogos</li>
                        <li>Assinar um plano de sócio-torcedor</li>
                        <li>Acompanhar seus pagamentos e faturas</li>
                    </ul>
                </div>
