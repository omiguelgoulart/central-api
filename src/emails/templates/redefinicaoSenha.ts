export const emailRedefinicaoSenha = (dados: {
    nome: string;
    token: string;
    linkBase: string;
}) => {
    const link = `${dados.linkBase}?token=${encodeURIComponent(dados.token)}`;
            ...
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
                ...
                <div style="padding: 30px 20px;">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="${link}" style="background-color: #c41e3a; color: white; padding: 14px 35px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: bold; font-size: 16px;">
                            Redefinir Senha
                        </a>
                    </div>
