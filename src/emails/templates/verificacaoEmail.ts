export const emailVerificacao = (dados: {
    nome: string;
            ...
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
                ...
                <div style="padding: 30px 20px;">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="${dados.linkVerificacao}" style="background-color: #c41e3a; color: white; padding: 14px 35px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: bold; font-size: 16px;">
                            Verificar E-mail
                        </a>
                    </div>
                    ...
                    <p style="color: #bbb; font-size: 12px; line-height: 1.4;">
                        ...
                        <span style="color: #c41e3a; word-break: break-all;">${dados.linkVerificacao}</span>
                    </p>
                </div>
