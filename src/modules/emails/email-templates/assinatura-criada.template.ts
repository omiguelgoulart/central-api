export interface AssinaturaCriadaProps {
    nome: string;
    plano: string;
    valor: number;
...
export const assinaturaCriadaTemplate = ({
    nome,
    plano,
    valor,
    periodicidade,
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px 20px;">
            ...
            <div style="background-color: #f9f9f9; padding: 15px; margin: 20px 0; border-left: 4px solid #c41e3a;">
                <p style="margin: 0 0 10px 0; color: #333; font-weight: bold;">Detalhes da Assinatura:</p>
                <p style="margin: 4px 0; color: #555;">
                    <strong style="display: inline-block; width: 140px;">Plano:</strong> ${plano}
                </p>
                <p style="margin: 4px 0; color: #555;">
                    <strong style="display: inline-block; width: 140px;">Valor:</strong> R$ ${valor.toFixed(2)} / ${periodicidade.toLowerCase()}
                </p>
                <p style="margin: 4px 0; color: #555;">
                    <strong style="display: inline-block; width: 140px;">Início:</strong> ${inicioEm}
                </p>
                ${proximaCobranca ? `<p style="margin: 4px 0; color: #555;">
                    <strong style="display: inline-block; width: 140px;">Próxima cobrança:</strong> ${proximaCobranca}
                </p>` : ''}
            </div>
