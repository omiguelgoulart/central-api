export interface AssinaturaCanceladaProps {
    nome: string;
    plano: string;
    canceladaEm: string;
    motivo?: string;
...
export const assinaturaCanceladaTemplate = ({
    nome,
    plano,
    canceladaEm,
    motivo,
}: AssinaturaCanceladaProps): string => {
    return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px 20px;">
            ...
            <div style="background-color: #f9f9f9; padding: 15px; margin: 20px 0; border-left: 4px solid #c41e3a;">
                ...
                <p style="margin: 4px 0; color: #555;">
                    <strong>Cancelado em:</strong> ${canceladaEm}
                </p>
                ${motivo ? `<p style="margin: 4px 0; color: #555;">
